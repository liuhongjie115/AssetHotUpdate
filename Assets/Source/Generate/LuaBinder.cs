...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		L.BeginModule("Core");
		Assets_Scripts_Core_ALogWrap.Register(L);
		Assets_Scripts_Core_LuaEngineWrap.Register(L);
		L.BeginModule("Utils");
		Assets_Scripts_Core_Utils_DateUtilsWrap.Register(L);
		L.EndModule();
		L.EndModule();
		L.BeginModule("ResLoader");
		Assets_Scripts_ResLoader_AssetLoaderWrap.Register(L);
		L.BeginModule("VO");
		Assets_Scripts_ResLoader_VO_AssetVOWrap.Register(L);
		L.EndModule();
		L.EndModule();
		L.BeginModule("Util");
		Assets_Scripts_Util_Single_Assets_Scripts_Core_LuaEngineWrap.Register(L);
		L.EndModule();
		L.EndModule();
		L.EndModule();
		...
		L.RegFunction("Action_string_bool_int", System_Action_string_bool_int);
		L.RegFunction("Func_string", System_Func_string);
		L.RegFunction("Action_Assets_Scripts_ResLoader_VO_AssetVO", System_Action_Assets_Scripts_ResLoader_VO_AssetVO);
		L.EndModule();
		L.EndModule();
		L.BeginPreLoad();
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int System_Action_string_bool_int(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<System.Action<string,bool,int>>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<System.Action<string,bool,int>>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int System_Action_Assets_Scripts_ResLoader_VO_AssetVO(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<System.Action<Assets.Scripts.ResLoader.VO.AssetVO>>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<System.Action<Assets.Scripts.ResLoader.VO.AssetVO>>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
