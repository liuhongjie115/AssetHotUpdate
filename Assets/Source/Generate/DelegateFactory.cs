...
public class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(System.Action<string,bool,int>), factory.System_Action_string_bool_int);
		dict.Add(typeof(System.Func<string>), factory.System_Func_string);
		dict.Add(typeof(System.Action<Assets.Scripts.ResLoader.VO.AssetVO>), factory.System_Action_Assets_Scripts_ResLoader_VO_AssetVO);
		...
		DelegateTraits<System.Action<string,bool,int>>.Init(factory.System_Action_string_bool_int);
		DelegateTraits<System.Func<string>>.Init(factory.System_Func_string);
		DelegateTraits<System.Action<Assets.Scripts.ResLoader.VO.AssetVO>>.Init(factory.System_Action_Assets_Scripts_ResLoader_VO_AssetVO);
		...
		TypeTraits<System.Action<string,bool,int>>.Init(factory.Check_System_Action_string_bool_int);
		TypeTraits<System.Func<string>>.Init(factory.Check_System_Func_string);
		TypeTraits<System.Action<Assets.Scripts.ResLoader.VO.AssetVO>>.Init(factory.Check_System_Action_Assets_Scripts_ResLoader_VO_AssetVO);
		...
		StackTraits<System.Action<string,bool,int>>.Push = factory.Push_System_Action_string_bool_int;
		StackTraits<System.Func<string>>.Push = factory.Push_System_Func_string;
		StackTraits<System.Action<Assets.Scripts.ResLoader.VO.AssetVO>>.Push = factory.Push_System_Action_Assets_Scripts_ResLoader_VO_AssetVO;
	}
	...
	class System_Action_string_bool_int_Event : LuaDelegate
	{
		public System_Action_string_bool_int_Event(LuaFunction func) : base(func) { }
		public System_Action_string_bool_int_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(string param0, bool param1, int param2)
		{
			func.BeginPCall();
			func.Push(param0);
			func.Push(param1);
		...
		public void CallWithSelf(string param0, bool param1, int param2)
		{
			func.BeginPCall();
			func.Push(self);
			func.Push(param0);
	...
	public System.Action<string,bool,int> System_Action_string_bool_int(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			System.Action<string,bool,int> fn = delegate(string param0, bool param1, int param2) { };
			return fn;
		}

		if(!flag)
		{
			System_Action_string_bool_int_Event target = new System_Action_string_bool_int_Event(func);
			System.Action<string,bool,int> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			System_Action_string_bool_int_Event target = new System_Action_string_bool_int_Event(func, self);
			System.Action<string,bool,int> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_System_Action_string_bool_int(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(System.Action<string,bool,int>), L, pos);
	}

	void Push_System_Action_string_bool_int(IntPtr L, System.Action<string,bool,int> o)
	{
		ToLua.Push(L, o);
	}
	...
	class System_Action_Assets_Scripts_ResLoader_VO_AssetVO_Event : LuaDelegate
	{
		public System_Action_Assets_Scripts_ResLoader_VO_AssetVO_Event(LuaFunction func) : base(func) { }
		public System_Action_Assets_Scripts_ResLoader_VO_AssetVO_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(Assets.Scripts.ResLoader.VO.AssetVO param0)
		{
			func.BeginPCall();
			func.PushObject(param0);
			func.PCall();
		...
		public void CallWithSelf(Assets.Scripts.ResLoader.VO.AssetVO param0)
		{
			func.BeginPCall();
			func.Push(self);
			func.PushObject(param0);
	...
	public System.Action<Assets.Scripts.ResLoader.VO.AssetVO> System_Action_Assets_Scripts_ResLoader_VO_AssetVO(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			System.Action<Assets.Scripts.ResLoader.VO.AssetVO> fn = delegate(Assets.Scripts.ResLoader.VO.AssetVO param0) { };
			return fn;
		}

		if(!flag)
		{
			System_Action_Assets_Scripts_ResLoader_VO_AssetVO_Event target = new System_Action_Assets_Scripts_ResLoader_VO_AssetVO_Event(func);
			System.Action<Assets.Scripts.ResLoader.VO.AssetVO> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			System_Action_Assets_Scripts_ResLoader_VO_AssetVO_Event target = new System_Action_Assets_Scripts_ResLoader_VO_AssetVO_Event(func, self);
			System.Action<Assets.Scripts.ResLoader.VO.AssetVO> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_System_Action_Assets_Scripts_ResLoader_VO_AssetVO(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(System.Action<Assets.Scripts.ResLoader.VO.AssetVO>), L, pos);
	}

	void Push_System_Action_Assets_Scripts_ResLoader_VO_AssetVO(IntPtr L, System.Action<Assets.Scripts.ResLoader.VO.AssetVO> o)
	{
		ToLua.Push(L, o);
	}
